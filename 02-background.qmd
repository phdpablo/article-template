...
Make sure to look into the thought of reproducible research practice [@sullivan2019; @wilson2017; @vuorre2018; @gilroy2019; @dogucu2022; @wiebels2021; @limongi2025a; @limongi2025b].

**Understanding Reproducibility Levels:**
...
-   **Proper Reproducibility:** Adding Quarto narrative (with RStudio and Git/Github) development and using `renv` for R package management.
